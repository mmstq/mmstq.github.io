                          ...
                          {project.link && project.link !== "#" && (
                            ...
                            >
                              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M3.609 1.814L13.792 12 3.61 22.186a.996.996 0 0 1-.61-.92V2.734a1 1 0 0 1 .609-.92zm10.89 10.893l2.302 2.302-10.937 6.333 8.635-8.635zm3.199-1.207l2.302 1.328-2.302 1.328-1.811-1.328 1.811-1.328zM5.864 3.415l10.937 6.333-2.302 2.302-8.635-8.635z" />
                              </svg>
                            </a>
                          )}
